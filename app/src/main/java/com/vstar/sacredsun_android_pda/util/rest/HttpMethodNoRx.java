...
public class HttpMethodNoRx {
    ...
    public static class SingleHolder {
        private static final HttpMethodNoRx INSTANCE = new HttpMethodNoRx();
    }

    public static HttpMethodNoRx getInstane(){
